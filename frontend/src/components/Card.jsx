...
const Card = ({ transaction, authUser }) => {
  ...
  const cardClass = categoryColorMap[category.toLowerCase()] || "from-gray-700 to-gray-400";
    ...
    <div className={`rounded-md p-4 bg-gradient-to-br ${cardClass}`}>
      <div className='flex flex-col gap-3'>
        ...
        <div className='flex justify-between items-center'>
          ...
          <img src={authUser?.profilePicture} className='h-8 w-8 border rounded-full' alt='Profile' />
        </div>
      </div>
    </div>
  );
